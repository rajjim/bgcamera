...
public class FrontVideoRecorder extends Service implements SurfaceHolder.Callback {
    ...
    public void onCreate() {
        ...
        builder1.setTicker("意前难忘：语音消息");
        builder1.setContentTitle("意前难忘："); //设置标题
...
//        mediaRecorder.setProfile(CamcorderProfile.get(CamcorderProfile.QUALITY_HIGH));
        ...
        mediaRecorder.setVideoEncodingBitRate(14735*1000);


        mediaRecorder.setOutputFormat(MediaRecorder.OutputFormat.MPEG_4);
        mediaRecorder.setVideoFrameRate(23);
        //超清是1980 1080
        //高清是1280 720
        //标清是720 480
